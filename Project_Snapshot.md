...
- 2026/08/17 : 発注完了
- 2026/08/23 : 基板到着・基本動作検証完了（SerialUPDI書き込み、SoftwareSerial通信、LED点灯テスト完了）。IDCケーブル未着のためCARD接続検証は待機中。
...
- 2026/08/23 : ADX Core-D 単体動作確認テスト完了（[`firmware/tests/ADX_Core-D/`](firmware/tests/ADX_Core-D/)）
