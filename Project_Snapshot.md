...
- 製造中
	- ADX Core V0
      ...
      - ターミナルそのものに対する研究が不足している気がする。
	      - 10,000個くらいであれば事前予約による個人在庫として繰り入れすればできるのではないか？
	      - このあたりは、実際にターミナルを使ってみて判断。
        - 絶縁型DCDCに移行した方がいいのではないか？
...
- ブログ
	- 2026/05/01 更新した。
	- そろそろGithubも含めた相互リンクが必要。
	- あとGoogleによるPV統計も入れた方がいいかもしれない。
- ADXplatform トップページ
    - サイト間リンクの再検討が必要そう。
- セキュリティ
    - tailscaleの掃除
